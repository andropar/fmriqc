...
Usage:
    ...
    from fmriqc.report_components.constants import METRIC_TOOLTIPS
    from fmriqc.report_components.formatting import format_run_label
    from fmriqc.report_components.numeric_constants import FD_THRESHOLD_DEFAULT

    # Legacy imports still work via utils.py (backward compatibility):
    from fmriqc.report_components.utils import format_run_label

    # For full report generation, use the reporting module:
    from fmriqc.reporting import generate_subject_report, generate_study_report
